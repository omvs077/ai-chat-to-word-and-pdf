  ...
  function imageParagraph(dataUrl, altWithDims) {
    ...
    if (!dimMatch) {
      return new docx.Paragraph({
        children: [new docx.TextRun({ text: `[Image: ${alt || 'image'} \u2014 could not be rendered]`, italics: true, color: '888888' })],
        spacing: { after: 120 }
      });
    }
    ...
    return new docx.Paragraph({
      children: [new docx.ImageRun({ data: dataUrl, transformation: { width: w, height: h } })],
      spacing: { after: 120 }
    });
  }
